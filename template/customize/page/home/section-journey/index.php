...
<div id="viora-home-journey-customizer-root" class="viora-home-journey-editor">
    <input type="hidden" id="viora-home-journey-initial-data"
        value="<?php echo esc_attr(wp_json_encode($journey_data)); ?>">

    <input type="hidden" id="viora-home-journey-data" value="<?php echo esc_attr(wp_json_encode($journey_data)); ?>">
    ...
    <div class="viora-home-journey-editor__section">
        ...
        <div class="viora-control">
            ...
            <input type="text" class="regular-text viora-journey-field" data-path="header.title"
                data-help-path="header.title">
        </div>
        <div class="viora-control">
            <label class="viora-field-label"><?php esc_html_e('CTA Text', 'viora'); ?></label>
            <input type="text" class="regular-text viora-journey-field" data-path="header.cta.text"
                data-help-path="header.cta.text">
        </div>
        <div class="viora-control">
            <label class="viora-field-label"><?php esc_html_e('CTA URL', 'viora'); ?></label>
            <div class="viora-link-row">
                <input type="url" class="regular-text viora-journey-field" data-path="header.cta.url"
                    data-help-path="header.cta.url">
                <button type="button" class="button viora-journey-choose-link" data-url-path="header.cta.url"
    ...
    <div class="viora-home-journey-editor__section">
        ...
        <div class="viora-control">
            ...
            <div class="viora-media-field" data-id-path="layout.visual.rocketIcon_id"
                data-url-path="layout.visual.rocketIcon_url" data-fallback-path="layout.visual.rocketIcon">
        ...
        <label class="viora-home-journey-editor__toggle">
            <input type="checkbox" class="viora-journey-field" data-path="layout.visual.rings.first"
                data-help-path="layout.visual.rings.first">
            <?php esc_html_e('Show first ring', 'viora'); ?>
        </label>
        <label class="viora-home-journey-editor__toggle">
            <input type="checkbox" class="viora-journey-field" data-path="layout.visual.rings.second"
                data-help-path="layout.visual.rings.second">
            <?php esc_html_e('Show second ring', 'viora'); ?>
        </label>
        <label class="viora-home-journey-editor__toggle">
            <input type="checkbox" class="viora-journey-field" data-path="layout.visual.flash"
                data-help-path="layout.visual.flash">
