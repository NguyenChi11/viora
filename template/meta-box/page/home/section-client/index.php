...
$client_data = isset($client_data) && is_array($client_data) ? $client_data : array();
wp_nonce_field('viora_home_client_meta_save', 'viora_home_client_meta_nonce');
?>

<div id="viora-home-client-metabox-root" class="viora-home-client-editor">
    <div class="viora-home-client-editor__top">
        <label class="viora-home-client-editor__toggle">
            <input type="checkbox" id="viora-home-client-enabled" name="viora_home_client_enabled" value="1"
                <?php checked($enabled, 1); ?>>
            <?php esc_html_e('Enable client section', 'viora'); ?>
        </label>
    ...
    <input type="hidden" id="viora-home-client-data-json" name="viora_home_client_data_json"
    ...
    <div class="viora-home-client-editor__section">
        ...
        <div class="viora-control">
            ...
            <input type="text" class="regular-text viora-client-field" data-path="heading.kicker"
                data-help-path="heading.kicker">
        </div>
        <div class="viora-control">
            <label class="viora-field-label"><?php esc_html_e('Title', 'viora'); ?></label>
            <input type="text" class="regular-text viora-client-field" data-path="heading.title"
                data-help-path="heading.title">
        </div>
        <div class="viora-control">
            <label class="viora-field-label"><?php esc_html_e('Lead text', 'viora'); ?></label>
            <textarea rows="3" class="large-text viora-client-field" data-path="heading.lede"
                data-help-path="heading.lede"></textarea>
        </div>
    </div>
    ...
    <template id="viora-client-card-template">
        <div class="viora-client-card" data-card-index="__INDEX__">
            <div class="viora-client-card__head">
                <button type="button" class="viora-toggle-client-card" data-card-index="__INDEX__"
                    aria-expanded="true">
                    <span class="viora-client-card__title"></span>
                    <span class="viora-client-card__chevron" aria-hidden="true"></span>
                </button>
                <button type="button"
                    class="button-link-delete viora-remove-client-card"><?php esc_html_e('Remove', 'viora'); ?></button>
            </div>
            ...
            <div class="viora-client-card__body">
                ...
                <div class="viora-control">
                    ...
                    <textarea rows="4" class="large-text viora-client-field" data-path="testimonials.__INDEX__.quote"
                        data-help-path="testimonials.quote"></textarea>
                </div>

                <div class="viora-control">
                    <label class="viora-field-label"><?php esc_html_e('Name', 'viora'); ?></label>
                    <input type="text" class="regular-text viora-client-field" data-path="testimonials.__INDEX__.name"
                        data-help-path="testimonials.name">
                </div>

                <div class="viora-control">
                    <label class="viora-field-label"><?php esc_html_e('Role', 'viora'); ?></label>
                    <input type="text" class="regular-text viora-client-field" data-path="testimonials.__INDEX__.role"
                        data-help-path="testimonials.role">
                </div>
            </div>
        </div>
    </template>
