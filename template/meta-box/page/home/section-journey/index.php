        ...
        <template id="viora-journey-card-template">
            <div class="viora-journey-card" data-item-index="__INDEX__">
                <div class="viora-journey-card__head">
                    <button type="button" class="viora-toggle-journey-card" data-card-index="__INDEX__" aria-expanded="true">
                ...
                <div class="viora-journey-card__body">
                    <div class="viora-control">
                        ...
                        <input type="text" class="regular-text viora-journey-field" data-path="layout.timeline.items.__INDEX__.year"
                            data-help-path="layout.timeline.items.0.year">
                    </div>

                    <div class="viora-control">
                        <label class="viora-field-label"><?php esc_html_e('Title', 'viora'); ?></label>
                        <input type="text" class="regular-text viora-journey-field" data-path="layout.timeline.items.__INDEX__.title"
                    ...
                    <div class="viora-control">
                        ...
                        <div class="viora-media-field" data-id-path="layout.timeline.items.__INDEX__.icon_id"
                            data-url-path="layout.timeline.items.__INDEX__.icon_url"
                            data-fallback-path="layout.timeline.items.__INDEX__.icon">
                            <input type="hidden" class="viora-media-id-field" data-path="layout.timeline.items.__INDEX__.icon_id">
